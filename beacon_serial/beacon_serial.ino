...
int buttonPin = 3;
int now = millis();
int i = 0;//for testing- remove this
...
// Serial.print(GPS.latitude,3);
  ...
  //RFarray[0] = 50*10000;//gives out the latitude

  //RFarray[1] = 0*10000;// gives out longitude
  
  RFarray[0] = (GPS.latitude);
  RFarray[1] = (GPS.longitude);
